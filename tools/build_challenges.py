...
CHALLENGES = [
  ...
  },
  {
    ...
    "examples": [{"input": "5", "output": "0 1 0 1 0"}, {"input": "6", "output": "0 1 0 1 0 1"}],
    "testCases": [
      {"input": "5", "expected": "0 1 0 1 0"},
      {"input": "6", "expected": "0 1 0 1 0 1"},
      {"input": "1", "expected": "0"},
      {"input": "8", "expected": "0 1 0 1 0 1 0 1"}
    ],
  ...
  },
  {
    ...
    "examples": [{"input": "4\n12 5 88 3", "output": "Minimum: 3"}, {"input": "3\n-7 -2 -15", "output": "Minimum: -15"}],
    "testCases": [
      {"input": "4\n12 5 88 3", "expected": "Minimum: 3"},
      {"input": "3\n-7 -2 -15", "expected": "Minimum: -15"},
      {"input": "1\n42", "expected": "Minimum: 42"},
      {"input": "5\n10 20 30 5 99", "expected": "Minimum: 5"}
    ],
  ...
  },
  {
    ...
    "examples": [{"input": "15 3", "output": "Count: 5"}, {"input": "10 4", "output": "Count: 2"}],
    "testCases": [
      {"input": "15 3", "expected": "Count: 5"},
      {"input": "10 4", "expected": "Count: 2"},
      {"input": "7 2", "expected": "Count: 3"},
      {"input": "20 5", "expected": "Count: 4"},
      {"input": "3 10", "expected": "Count: 0"}
    ],
