...
function renderTeacherMetrics() {
  ...
  if (elAvg) elAvg.textContent = `${avgCleared} / ${LEVELS.length}`;
...
function selectStudent(student) {
  ...
  const elTotal = document.getElementById('insp-total-label');
  ...
  if (elTotal) elTotal.textContent = `/ ${LEVELS.length} CLEARED`;
